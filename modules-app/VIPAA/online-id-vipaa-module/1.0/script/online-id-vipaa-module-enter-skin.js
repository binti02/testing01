$(function () {
	...
	function handleVerifyAuth(response){
		...
		if(response.Completion && response.Completion.value === 'ALLOW'){
			...
			var stepupRDUrl = "https://secure.bankofamerica.com/sparta/login/ah-omni-secondfactor-auth";
...
$(document).ready( function() {
	...
	var PT_ENVIRONMENT_SUFFIX = "-helix.ecnp.bankofamerica.com/index.html";
	var SCRIPT_MANAGER_LOGIN_PATH = "client/helper/spa-assets/components/utilities/client-helper/script-manager-l/script-manager-login.12";
	var NON_PT_ENVIRONMENT_PREFIX = "https://uat-secure-/";
	var NON_PT_ENVIRONMENT_SUFFIX = "-helix.bac-assets.com/sparta/index.html";
